      ...
      <div class="col-12 col-lg-3 pr-lg-2">
        <div class="card">
          ...
          <div class="card-body overflow-auto" id="jstree">
            @include('admin.isiuraian.rpjmd.menu-tree')
          </div>
        </div>
      </div>
...
@section('outer')
  ...
  @include('admin.isiuraian.partials.modal-edit', ['action' => route('admin.rpjmd.update') ])
  @include('admin.isiuraian.partials.modal-upload-file', ['action' => route('admin.rpjmd.files.store', $tabelRpjmd->id) ])
  @include('admin.isiuraian.partials.modal-year', ['action' => route('admin.rpjmd.destroy_tahun', [$tabelRpjmd->id, $years])])
  @endsection
